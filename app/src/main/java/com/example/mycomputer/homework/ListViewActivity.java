...
public class ListViewActivity extends BaseActivity {
    String[] names = {"作业1：hello world!", "作业2：放一个图片", "作业3：手机信息及dpi", "作业4：点击图片循环", "作业5：双缓冲画心",
            ...
            "作业19：edittext里显示选择的日期", "作业20：Tabhost 三个选项卡",
            ...
            "作业41：震动", "作业42：闹钟", "作业44：电话拦截","作业46：网络共享api","作业47：指南针","作业48：摇一摇"};
    Class[] cl = {HomeWork01Activity.class, HomeWork02Activity.class, HomeWork03Activity.class, HomeWork04Activity.class, HomeWork05Activity.class,
            ...
            HomeWork19Activity.class, HomeWork20Activity.class,
            ...
            HomeWork41Activity.class, HomeWork42Activity.class,HomeWork44Activity.class,HomeWork46Activity.class,HomeWork47Activity.class,HomeWork48Activity.class};
    ListView listView;
