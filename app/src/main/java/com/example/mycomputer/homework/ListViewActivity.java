...
public class ListViewActivity extends BaseActivity {
    String[] names = {"作业1：hello world!", "作业2：放一个图片", "作业3：手机信息及dpi", "作业4：点击图片循环", "作业5：双缓冲画心",
            ...
            "作业27：下载", "作业28：手机及平板适配", "作业30-2：画板", "作业30-3：逐帧动画", "作业31：自动登录",
            "作业32：数据库操作", "作业32-1：SD卡浏览器可打开jpg图片", "作业33：图片放大缩小",
            ...
            "作业：录制视频","定时更换壁纸","百度地图","Butter Knife"};
    Class[] cl = {HomeWork01Activity.class, HomeWork02Activity.class, HomeWork03Activity.class, HomeWork04Activity.class, HomeWork05Activity.class,
            ...
            ShiPinActivity.class,dingshibizi.class, BaiDuMapActivity.class,ButterKnife.class};
    ListView listView;
