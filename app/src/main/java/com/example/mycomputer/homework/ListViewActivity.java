...
public class ListViewActivity extends BaseActivity {
    String[] names = {"作业1：hello world!", "作业2：放一个图片", "作业3：手机信息及dpi", "作业4：点击图片循环", "作业5：双缓冲画心",
            ...
            "作业25：省份所在城市", "作业26：横竖屏转换", "作业27：下载","作业28：平板电脑和手机适配", "作业30-1：爆炸加声音", "作业32-01：SD卡浏览",
            "作业33：放大缩小图片", "作业34：左右滑换页", "作业35：添加手势","作业36：百度语音TTS","作业38：群发短信","作业41：震动","作业42：画板"};
    Class[] cl = {HomeWork01Activity.class, HomeWork02Activity.class, HomeWork03Activity.class, HomeWork04Activity.class, HomeWork05Activity.class,
            ...
            HomeWork25Activity.class, HomeWork26Activity.class, HomeWork27Activity.class,HomeWork28Activity.class, HomeWork30_03Activity.class, HomeWork32_01Activity.class,
            HomeWork33Activity.class, HomeWork34Activity.class, HomeWork35Activity.class,HomeWork36Activity.class,HomeWork38Activity.class,HomeWork41Activity.class,HuaBanActivity.class};
    ListView listView;
